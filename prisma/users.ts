...
export const routes = [
    ...
    { name: 4, isActive: true },
    { name: 5, isActive: true },
    { name: 6, isActive: true },
]
...
export const users: User[] = [
    ...
    {
        email: 'angel.ventura@gmail.com',
        name: 'angel',
        lastNameFirst: 'ventura',
        lastNameSecond: 'ventura',
        username: 'angel.ventura',
        password: '123456',
        isActive: true,
        role: 'ASESOR',
        address: 'pro capital',
    ...
    {
        email: 'karla.aguileta@gmail.com',
        name: 'karla maria',
        lastNameFirst: 'aguileta',
        lastNameSecond: 'calderon',
        username: 'karla.aguileta',
        password: '123456',
        isActive: true,
        role: 'ASESOR',
        address: 'pro capital',
    ...
    {
        email: 'yeni.colunga@gmail.com',
        name: 'yeni yadira',
        lastNameFirst: 'colunga',
        lastNameSecond: 'ventura',
        username: 'yeni.colunga',
        password: '123456',
        isActive: true,
        role: 'ASESOR',
        address: 'pro capital',
